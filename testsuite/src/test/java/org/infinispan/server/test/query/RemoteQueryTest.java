...
public class RemoteQueryTest {
    ...
    @InfinispanResource
    private RemoteInfinispanServers remoteServers;
    ...
    public void setUp() throws Exception {
        provider = new MBeanServerConnectionProvider(remoteServers.getServer("remote-query").getHotrodEndpoint().getInetAddress().getHostName(), 9999);
        rcmFactory = new RemoteCacheManagerFactory();
        ConfigurationBuilder clientBuilder = new ConfigurationBuilder();
        clientBuilder.addServer()
                        .host(remoteServers.getServer("remote-query").getHotrodEndpoint().getInetAddress().getHostName())
                        .port(remoteServers.getServer("remote-query").getHotrodEndpoint().getPort())
